              ...
              ListView(
                ...
                children: [
                  CustomCard(
                    ...
                    description:
                        'Дорогие друзья и партнеры, мобильное приложение нашего стартапа CITIQUIZ было успешно запущено в первый раз.',
                    date: '10.12.2023',
                    image: Image.asset(
                  ...
                  CustomCard(
                    ...
                    description:
                        'Рады вам сообщить, что в ближайшее время в приложении будет реализована функция прохождения квизов!',
                    date: '15.12.2023',
                    image: Image.asset(
                  ...
                  CustomCard(
                    ...
                    description:
                        'Уважаемые пользователи, вы можете предложить свои вопросы и правильные ответы к ним.',
                    date: '15.12.2023',
                    image: Image.asset(
                  ...
                  CustomCard(
                    ...
                    description:
                        'Нашему стартапу требуются инвесторы. Чтобы узнать подробности свяжитесь с нами.',
                    date: '17.12.2023',
                    image: Image.asset(
